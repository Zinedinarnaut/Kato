...
type LayoutRouteId = RouteId | "/(authed)/profile" | "/(nonauthed)" | "/(nonauthed)/ai" | "/(nonauthed)/ai/chat" | "/(nonauthed)/catalog" | "/(nonauthed)/collections" | "/(nonauthed)/faq" | "/(nonauthed)/home" | "/(nonauthed)/login" | "/(nonauthed)/schedule" | "/(nonauthed)/support" | "/(nonauthed)/test/easter" | "/(nonauthed)/test/[id]/[user]" | "/(nonauthed)/watch/[slug]" | null
type LayoutParams = RouteParams & { id?: string,user?: string,slug?: string }
