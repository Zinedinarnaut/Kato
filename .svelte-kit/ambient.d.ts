...
declare module '$env/static/private' {
	export const REDIS_URI: string;
	export const SIMKL_SECRET: string;
	...
	export const Poetry1: string;
	export const poetry2: string;
...
declare module '$env/static/public' {
	export const PUBLIC_SIMKL_ID: string;
